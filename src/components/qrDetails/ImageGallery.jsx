...
export function ImageGallery() {
  return (
    <div className="flex gap-5 self-center max-w-full w-[260px]">
      <img
        loading="lazy"
        ...
        alt="QR code preview"
        className="object-contain shrink-0 max-w-full rounded aspect-square shadow-[0px_8px_16px_rgba(0,0,0,0.06)] w-[80px]"
      />
      <img
        loading="lazy"
